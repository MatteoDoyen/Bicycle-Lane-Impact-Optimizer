...
double dijkstra_forward(struct vertex_t **graph, int V, double **dist_array, int *parent_array, path_t *path);
double dijkstra_backward(struct vertex_t **graph, int V, double **dist_array, int *parent_array, path_t *path);
